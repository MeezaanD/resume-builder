  ...
  <div>
    ...
    <div v-for="(experience, index) in data" :key="index">
      ...
      <el-form-item label="Start Date">
        <el-date-picker v-model="experience.startDate" type="date" placeholder="Select start date"></el-date-picker>
      </el-form-item>
      <el-form-item label="End Date">
        <el-date-picker v-model="experience.endDate" type="date" placeholder="Select end date" :disabled="experience.currentJob"></el-date-picker>
      ...
      <el-form-item label="Description">
        <el-input type="textarea" v-model="experience.jobDescription" placeholder="Enter job description"></el-input>
      </el-form-item>
		...
		<el-popconfirm
			...
			@confirm="deleteExperience(index)"
			placement="top"
		>
			<template #reference>
